...
{
    public function submit(HireMeRequest $request){
        ...
        if ($validator->fails()) {
            return redirect('/#call-to-action'); 
        }
        ...
        return redirect('/#call-to-action')->with('success', 'Sikeresen elküldted az üzeneted! Hamarosan felveszem Veled a kapcsolatot!');
